...
const newsAllTeamsReducer = (state = initialState, { type, payload }) => {
  switch (type) {
    ...
    case FETCH_NEWS_ALL_TEAMS_SUCCESS:
      ...
      return {
        ...state,
        newsAllLoading: false,
        newsAllTeamsData: payload.newsAllTeams,
      };
...
export default newsAllTeamsReducer;
